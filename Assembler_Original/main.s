	...
	.align 8
.LC0:
	.string	"input the size of the array. The size must be 2 or larger. If size is entered wrong, please enter it again "  	#кладем в секцию rodata строку
.LC1:
	.string	"%d" #кладем в секцию rodata строку
.LC2:
	.string	"Incorrect Input! Try again! " #кладем в секцию rodata строку
	.align 8
.LC3:
