...
<br>![](photos/max11.png)
### Заключение
В очередной раз, при изменении ассемблер кода, функциональность программы никак не измениалсь. Она по прежднему выдает корректные ответы на вышеописанные входные данные.
